...
parser.add_argument("-bs", "--batchSize", type=int, help="Batch size for the second stage", default=2)
...
parser.add_argument("-train_path", type=str, default="/home/cuidongdong/data/modelnet40_images_new_12x/*/train")
parser.add_argument("-val_path", type=str, default="/home/cuidongdong/data/modelnet40_images_new_12x/*/test")
...
if __name__ == '__main__':
    ...
    print("training the mvcnn in main funciton")
